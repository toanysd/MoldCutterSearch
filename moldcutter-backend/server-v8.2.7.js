...
const ALLOWED_CSV_FILES = new Set([
  ...
  'web_employees.csv',
  'web_jobs.csv',
  'web_processingitems.csv',

  'web_destinations.csv',

  // Logs
  'web_statuslogs.csv',
  'web_shiplog.csv',
  'web_locationlog.csv',
  'web_usercomments.csv',
  'web_teflonlog.csv',

  // New tables (you confirmed these exist on GitHub)
  'web_processingdeadline.csv',
  'web_processingstatus.csv',
  'web_itemtype.csv',
  'web_plasticforforming.csv',
  'web_machiningcustomer.csv',
  'web_tray.csv',
  'web_worklog.csv'
