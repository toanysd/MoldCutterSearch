...
(function (global) {
  ...
  var TMPL_MAIN = [
    ...
    '      <input type="file" id="puFileInputCamera" capture="environment" style="display:none">',
    '      <input type="file" id="puFileInputGeneric" multiple style="display:none">',
    '    </div>',
    /* Drop zone */
    ...
    '    .pu-action-sheet-wrapper { width: 100%; border-radius: 18px 18px 0 0; padding: 16px; padding-bottom: 34px; background: #f4f4f5; font-weight: 700; pointer-events: auto; }',
    ...
    '      <button class="pu-editor-tab" data-tab="crop" style="display:none !important"><i class="fas fa-crop-alt"></i> トリミング / Cắt</button>',
    '    </div>',
  ...
  PhotoUploadModule.prototype._injectInlineStyles = function () {
    ...
    st.textContent = [
      ...
      '#puActionSheetOverlay{ z-index: 2147483605 !important; }',
      '#puSecurityOverlay{ z-index: 2147483606 !important; }',
